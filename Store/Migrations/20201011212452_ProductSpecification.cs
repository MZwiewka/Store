    ...
    public partial class ProductSpecification : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpecificationFieldID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationField", x => x.SpecificationFieldID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpecificationFieldValueID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SpecificationFieldID = table.Column<int>(nullable: true),
                    ProductID = table.Column<int>(nullable: false),
                    Value = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationFieldValue", x => x.SpecificationFieldValueID);
                    table.ForeignKey(
